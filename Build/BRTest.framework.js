...
var ASM_CONSTS = {
  8119092: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 8119147: function($0) {performance.now = function() { return $0; };},  
 8119195: function($0) {performance.now = function() { return $0; };},  
 8119243: function() {performance.now = Module['emscripten_get_now_backup'];},  
 8119298: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 8119359: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 8119423: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _JS_getConnectAccount() {
  ...
  function _JS_getSendTransactionResponse() {
  ...
  function _JS_getSendTransactionResponseData() {
  ...
  function _JS_getSignMessageResponse() {
  ...
  function _JS_getSignTypedMessageResponse() {
  ...
  function _JS_resetConnectAccount() {
      window.web3gl.connectAccount = "";
    }

  function _JS_resetSendTransactionResponse() {
      window.web3gl.sendTransactionResponse = "";
    }

  function _JS_resetSendTransactionResponseData() {
      window.web3gl.sendTransactionResponseData = "";
    }

  function _JS_resetSignMessageResponse() {
        window.web3gl.signMessageResponse = "";
    }

  function _JS_resetSignTypedMessageResponse() {
        window.web3gl.signTypedMessageResponse = "";
    }

  function _JS_sendTransaction(to, value, gasLimit, gasPrice) {
  ...
  function _JS_sendTransactionData(to, value, gasLimit, gasPrice, data) {
  ...
  function _JS_signMessage(message) {
      window.web3gl.signMessage(UTF8ToString(message));
    }

  function _JS_signTypedMessage(domain, types, value) {
...
var asmLibraryArg = {
  ...
  "JS_getConnectAccount": _JS_getConnectAccount,
  "JS_getSendTransactionResponse": _JS_getSendTransactionResponse,
  "JS_getSendTransactionResponseData": _JS_getSendTransactionResponseData,
  "JS_getSignMessageResponse": _JS_getSignMessageResponse,
  "JS_getSignTypedMessageResponse": _JS_getSignTypedMessageResponse,
  "JS_resetConnectAccount": _JS_resetConnectAccount,
  "JS_resetSendTransactionResponse": _JS_resetSendTransactionResponse,
  "JS_resetSendTransactionResponseData": _JS_resetSendTransactionResponseData,
  "JS_resetSignMessageResponse": _JS_resetSignMessageResponse,
  "JS_resetSignTypedMessageResponse": _JS_resetSignTypedMessageResponse,
  "JS_sendTransaction": _JS_sendTransaction,
  "JS_sendTransactionData": _JS_sendTransactionData,
  "JS_signMessage": _JS_signMessage,
  "JS_signTypedMessage": _JS_signTypedMessage,
  "JS_web3Connect": _JS_web3Connect,
  "Request": _Request,
